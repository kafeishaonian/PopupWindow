...
class BubbleDrawable extends Drawable {
    ...
    private void updateBorderArrowPeak(BubbleStyle.ArrowDirection direction, BubbleStyle.ArrowPosPolicy policy, PointF arrowTo, Shape outShape) {
        switch (direction) {
            case Left:
                ...
                outShape.ArrowPeakY = DisplayUtils.bound(outShape.Rect.top + outShape.TopLeftRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
                ...
                break;
            case Up:
                outShape.ArrowPeakX = DisplayUtils.bound(outShape.Rect.left + outShape.TopLeftRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
            ...
            case Right:
                ...
                outShape.ArrowPeakY = DisplayUtils.bound(outShape.Rect.top + outShape.TopRightRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
                ...
                break;
            case Down:
                outShape.ArrowPeakX = DisplayUtils.bound(outShape.Rect.left + outShape.BottomLeftRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
                        getUpDownArrowPeakX(policy, arrowTo, outShape),
    ...
    public void draw(Canvas canvas) {
        ...
        if (mFillColorArray != null) {
            LinearGradient mShader = new LinearGradient(mBorderShape.Rect.left, mBorderShape.Rect.top, mBorderShape.Rect.width(),mBorderShape.Rect.height(),
                    mFillColorArray, null, Shader.TileMode.CLAMP);
        ...
        if (mBorderShape.BorderWidth > 0) {
            ...
            if (mFillColorArray != null) {
                LinearGradient mShader = new LinearGradient(mBorderShape.Rect.left, mBorderShape.Rect.top, mBorderShape.Rect.width(),mBorderShape.Rect.height(),
                        mFillColorArray, null, Shader.TileMode.CLAMP);
                mBorderPaint.setShader(mShader);
            } else {
                mBorderPaint.setColor(mFillColor);
            }
