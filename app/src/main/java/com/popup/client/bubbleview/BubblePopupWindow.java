...
import com.popup.client.bubbleview.BubbleStyle.ArrowDirection;
import com.popup.client.bubbleview.BubbleStyle.ArrowPosPolicy;
import static com.popup.client.bubbleview.RelativePos.CENTER_HORIZONTAL;
...
public class BubblePopupWindow extends PopupWindow {
    ...
    private int mPadding = DisplayUtils.dp2px(2);
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public void showArrowTo(View anchor, ArrowDirection direction, int margin,int marginV) {
        RelativePos relativePos;
        switch (direction) {
            case Up:
                relativePos = new RelativePos(CENTER_HORIZONTAL, RelativePos.BELOW);
        ...
        showArrowTo(anchor, relativePos, margin, marginV);
    }
    ...
    public void showArrowTo(View anchor, RelativePos relativePos, int marginH, int marginV) {
        try {
            ...
            Log.d(TAG,"showArrowTo screenWidth = " + screenWidth + ",screenHeight = " + screenHeight
                    +" ,mPadding = " + mPadding);
...
//                    View.MeasureSpec.makeMeasureSpec(screenHeight - 2 * mPadding, View.MeasureSpec.AT_MOST));
            ...
            setWidth(contentWidth + mPadding * 2);
    ...
    private static int getNavigationBarHeightDelta(View view) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT_WATCH) {
            return DisplayUtils.getNavigationBarHeight(view);
        } else {
            return 0;
        }
    }
