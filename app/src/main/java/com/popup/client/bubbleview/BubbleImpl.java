...
class BubbleImpl implements BubbleStyle {
    ...
    void init(View view, Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mArrowHeight = ta.getDimension(R.styleable.BubbleStyle_bb_arrowHeight, DisplayUtils.dp2px(6));
            mArrowWidth = ta.getDimension(R.styleable.BubbleStyle_bb_arrowWidth, DisplayUtils.dp2px(10));
            ...
            float radius = ta.getDimension(R.styleable.BubbleStyle_bb_cornerRadius, DisplayUtils.dp2px(4));
    ...
    void updateDrawable(int width, int height, boolean drawImmediately) {
        ...
        if (drawImmediately) {
            ...
            mBubbleDrawable.setFillColor(mFillColorArray);
